...
function setUpPatientTriageContent(response)
{
  ...
  $.each(response.list, function(index, value)
  {
    ...
    {
       triage_time_data += '<li class="timeline_item"><div class="date col-xs-4 md-size">' + value.date + '</div><div class="status col-xs-4 col-xs-offset-4"><i class="fa fa-2x fa-angle-right"></i><div class="visited"><span>Clinic<br>visit</span></div></div></li>';
    }
